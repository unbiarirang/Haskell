...
test_1_3 = assertEqual 0 (Bachelor.bachelor $ [1..5000000] ++ [0] ++ [5000000,4999999..1])
test_1_4 = assertEqual 0 (Bachelor.bachelor $ 0:[1..5000000] ++ [5000000,4999999..1])
test_1_5 = assertEqual 0 (Bachelor.bachelor $ [1..5000000] ++ [5000000,4999999..1] ++ [0])
test_1_6 = assertEqual 0 (Bachelor.bachelor [0,1,1])
test_1_7 = assertEqual 0 (Bachelor.bachelor [1,0,1])
test_1_8 = assertEqual 0 (Bachelor.bachelor [1,1,0])
...
test_3_3 = assertEqual (sum [1..10^6]) (MaxSubstrSum.solution [1..10^6])
test_3_4 = assertEqual 15 (MaxSubstrSum.solution [0,1,2,3,4,5,4,3,2,1])
test_3_5 = assertEqual 15 (MaxSubstrSum.solution [1,3,5,4,3,2,1])
test_3_6 = assertEqual 3 (MaxSubstrSum.solution [1,2,5,4,3,2,1])
